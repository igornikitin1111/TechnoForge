"""
Django settings for PTU16_technoforge project.
...
ALLOWED_HOSTS = ['main.local','localhost', '127.0.0.1'] 
...
AUTH_USER_MODEL = 'main.UserForge' 
 
AUTHENTICATION_BACKENDS = [
    'main.backends.UserForgeAuthBackend',
